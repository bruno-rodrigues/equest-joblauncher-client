...
class StubApi
{
    ...
    /**
     * jobsJobIdPostingsPostingIdDeleteWithHttpInfo
     *
     * Delete/unpost job from specific board
     *
     * @param int $job_id Job ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function jobsJobIdPostingsPostingIdDeleteWithHttpInfo($job_id, $posting_id)
    {
        
        // verify the required parameter 'job_id' is set
        if ($job_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $job_id when calling jobsJobIdPostingsPostingIdDelete');
        }
        // verify the required parameter 'posting_id' is set
        if ($posting_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $posting_id when calling jobsJobIdPostingsPostingIdDelete');
        }
