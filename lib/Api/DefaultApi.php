...
class DefaultApi
{
     ...
     *
     * @return \Swagger\Client\Model\BoardSelector[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * Returns boards available to post.
     *
     * @return Array of \Swagger\Client\Model\BoardSelector[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getBoardsWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\BoardSelector[]',
                '/boards'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\BoardSelector[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\BoardSelector[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function getJobWithHttpInfo($job_id)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\Job', $httpHeader, 'job_type'), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
     ...
     *
     * @param int $job_id Job ID (required)
     * @param bool $include_deleted Include Deleted (optional, default to false)
     * @return \Swagger\Client\Model\Posting[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getJobPostings($job_id, $include_deleted = null)
    {
        list($response) = $this->getJobPostingsWithHttpInfo($job_id, $include_deleted);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getJobPostingsWithHttpInfo($job_id, $include_deleted = null)
    {
        // verify the required parameter 'job_id' is set
        if ($job_id === null) {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getJobs($requisition_number = null, $include_deleted = null)
    {
        list($response) = $this->getJobsWithHttpInfo($requisition_number, $include_deleted);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getJobsWithHttpInfo($requisition_number = null, $include_deleted = null)
    {
        // parse inputs
        $resourcePath = "/jobs";
        $httpBody = '';
