...
- Build date: 2016-04-11T23:21:51.514Z
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**boardsGet**](docs/DefaultApi.md#boardsget) | **GET** /boards | Returns boards available to post.
*DefaultApi* | [**draftsDraftIdGet**](docs/DefaultApi.md#draftsdraftidget) | **GET** /drafts/{draft_id} | Get Job Draft Dtaa
*DefaultApi* | [**draftsDraftIdPostingsPost**](docs/DefaultApi.md#draftsdraftidpostingspost) | **POST** /drafts/{draft_id}/postings | Post job draft to specified boards
*DefaultApi* | [**draftsPost**](docs/DefaultApi.md#draftspost) | **POST** /drafts | Create a job draft for posting to boards
*StubApi* | [**jobsJobIdDelete**](docs/StubApi.md#jobsjobiddelete) | **DELETE** /jobs/{job_id} | Delete/unpost job and close it
*StubApi* | [**jobsJobIdGet**](docs/StubApi.md#jobsjobidget) | **GET** /jobs/{job_id} | Retrieve job data and status
*StubApi* | [**jobsJobIdPatch**](docs/StubApi.md#jobsjobidpatch) | **PATCH** /jobs/{job_id} | Change job data without changing board selection
