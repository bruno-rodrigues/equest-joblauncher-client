...
java -jar swagger-codegen-cli-2.2.1.jar generate -l php \
     -c joblauncher-client-php/config.json -o . \
     -i /var/www/equest3/src/Equest/PostJobApiBundle/Resources/public/swagger.json
```
...
- API version: 1.2
- Build date: 2017-08-28T10:06:59.829Z
